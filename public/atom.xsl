        ...
        <div class="container">
          ...
          <div class="info-box">
            <h2>
              ...
              <span>This is an Atom Feed</span>
            </h2>
            <p>This is a web feed in Atom format. Subscribe to it using your favorite RSS reader to get automatic updates when new content is published.</p>
            <p style="margin-top: 10px;">
              <strong>Feed URL:</strong> <code><xsl:value-of select="/atom:feed/atom:link[@rel='alternate']/@href"/>/atom.xml</code>
            </p>
          </div>
